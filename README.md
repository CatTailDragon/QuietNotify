...
本项目完全由 AI Agent 完成功能实现、问题排查、代码审查、文档说明。

使用ChatGPT 5.6 sol 与 OpenCode

目前总共使用 Tokens:2602.6万 花费:¥28.36（2026.8.28）

开发所用的提示词可以在 提示词。txt 文件中找到
如果继续使用 AI 修改项目，请让 AI 先阅读项目根目录下的 `AIREADME.md`。
